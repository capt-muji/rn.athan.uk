...
describe('the mock feed, downloaded on Tuesday 15 September 2026 around 15:30 in London', () => {
  ...
  it.each(['2026-09-15T14:30:00.000Z', '2026-09-15T14:30:00.001Z', '2026-09-15T14:30:59.999Z'])(
    'puts Asr next, 180 to 239.999 seconds after a download at %s, with the three prayers before it passed',
    (iso) => {
      ...
      expect(asr - readAt.getTime()).toBeGreaterThanOrEqual(3 * MINUTE);
      expect(asr - readAt.getTime()).toBeLessThan(4 * MINUTE);
