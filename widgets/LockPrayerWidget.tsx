 ...
 * — see ai/AGENTS.md). All helpers must live inside each function: the
 * 'widget' directive serializes the body alone, and @expo/ui identifiers
 * resolve as globals in the extension's JS runtime.
 */
