...
// Each item's Apple and Android badges are drawn as icons, and every .svg loads as one shared mock, so the badges
// cannot be told apart here and no test claims them
