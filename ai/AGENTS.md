...
| **alarmClock backport** | `ai/prompts/alarmclock-backport.md` | SUPERSEDED 2026-09-18: #49687 ships in SDK 58, adopted by session 12 of the SDK 58 programme. The branch is KEPT, frozen on SDK 57, as the known-good backup; deletion day (B9) cancelled by owner ruling |
