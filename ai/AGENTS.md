...
| **Android widget sizing (15d)** | `ai/prompts/android-widget-proportional-sizing.md` | the Android widgets are built from fixed dp and clip their prayer names on any launcher but the 3T's |
