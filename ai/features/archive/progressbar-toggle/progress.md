...
### Core Implementation
- [x] Add `progressBarVisibleAtom` to `stores/ui.ts`
  - Storage key: `preference_progressbar_visible`
  - Default: `true`
...
- [x] Animate ProgressBar opacity
  - Subscribe to `progressBarVisibleAtom`
...
- [x] Add to database cleanup function
  - Added `preference_progressbar_visible` to cleanup (commented)
...
- [x] Create feature documentation
  - Created minimal feature doc in `ai/features/progressbar-toggle/`
...
ai/features/progressbar-toggle/ # Feature documentation
```
