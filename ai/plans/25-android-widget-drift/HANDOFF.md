...
| A4 | The remaining worst case is ~2 minutes, not 20 to 24 | That is all I could reproduce over ~30 minutes of sampling. **Both phones were on charge the whole time, which keeps them `ACTIVE` and never lets them reach deep doze.** Your original 20-24 min sighting was on a discharging, long-idle phone on an older build | The mechanism I fixed is real and measured regardless, but a discharging overnight phone is genuinely untested. Unplug the X8 and re-run the sampler for the real answer |
