...
| 5 | 9. Keep yesterday's still-due rows after 00:00 | `ai/prompts/keep-still-due-rows-after-midnight.md` | `ai/plans/09-keep-still-due-rows-after-midnight/PLAN.md` | NEEDS REPLAN: step 2 needs a test the plan omits (an older-than-yesterday refused-cancel record) to pass the 100% coverage gate; owner, 2026-09-17 | `07042baf` | nothing |
