...
| 23 | 24. A Lock Screen widget showing the whole day's list (iOS only) | `ai/plans/24-lock-widget-full-day-list/PLAN.md` section 2 | `ai/plans/24-lock-widget-full-day-list/PLAN.md` | READY | `b707b101` | nothing. **A 2026-09-25 attempt built this as a systemLarge HOME widget by misreading the brief and was reverted in full; the owner re-queued it as Lock Screen.** Its step 1 is a measurement the owner must rule on before the rest is planned: 6 rows do not fit an accessoryRectangular slot at the 14pt the owner approved |
