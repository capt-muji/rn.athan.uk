...
| 22 | 23. Lock Screen widgets: a countdown layout, the colour hierarchy, readable sizes (iOS only) | `ai/plans/23-lock-widget-countdown-layout/PLAN.md` section 2 (owner decisions taken on device) | `ai/plans/23-lock-widget-countdown-layout/PLAN.md` | IN PROGRESS | `97bef7f4` | nothing |
| 23 | 11. Moonsighting research, session 2 | `ai/prompts/moonsighting-research-2.md` | `ai/plans/11-moonsighting-research-2/PLAN.md` | NOT PLANNED, deferred until further notice (owner 2026-09-18; runs after the SDK 58 programme and the deferred features) | | everything above |
