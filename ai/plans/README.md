...
| 15 | 19. Widget polish: Android dark colours match iOS, the active pill overhang, the horizon to 7 days, the iOS flag on | `ai/prompts/widget-polish-and-horizon.md` | `ai/plans/19-widget-polish-and-horizon/PLAN.md` | IN PROGRESS | `5926e35f` | nothing |
