...
| 14 | 17. Widget timeline horizon: 14 to 30 days, both platforms | `ai/plans/SDK58-PROGRAMME.md` §17 | `ai/plans/17-ios-timeline-horizon/PLAN.md` | EXECUTED | `53d9baba` | nothing |
