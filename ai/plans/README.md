...
| 11 | 16a. iOS widgets: finish the containerBackground fix (stuck kinds, first-placement UX, cadence table) | `ai/prompts/ios-widget-container-background.md` | none (investigation-first session, owner 2026-09-19 evening) | NOT PLANNED | | nothing |
