...
| 12 | 15d. Android widgets: proportional sizing, they break outside the 3T | `ai/prompts/android-widget-proportional-sizing.md` | `ai/plans/15d-android-widget-proportional-sizing/PLAN.md` | IN PROGRESS | `7b38e5a6` | nothing (both Android phones answered `adb` on 2026-09-24; the owner confirmed the Find X8 stays on the bench for this session) |
