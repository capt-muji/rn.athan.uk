...
| 20 | 21. Bump every non-SDK package to its absolute latest | `ai/plans/README.md` "Waiting on the owner" (owner 2026-09-18, rescoped 2026-09-25) | `ai/plans/21-bump-everything-latest/PLAN.md` | EXECUTED | `3df9733c` | nothing |
